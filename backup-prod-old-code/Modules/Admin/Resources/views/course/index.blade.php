                ...
                <form method="get">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <label class="control-label">&nbsp;</label>
                            <div>
                                <button class="btn btn-success btn-rounded" type="button" data-toggle="modal" data-target="#modalImport">Import</button>
                            </div>
        ...
        <div class="panel panel-bordered-primary">
            ...
            @include("admin::includes.data-table",[
                ...
                'fields' => [
                    ...
                    ['field' => 'schools','title' => 'Trường','formatter' => 'listSchool'],
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin::course.import') }}" enctype="multipart/form-data" method="POST">
                        <div class="form-group">
                            <label for="file">File</label>
                            <input name="fileImport" type="file" class="form-control" id="file">
                        </div>
...
@section('after_scripts')
    ...
    <script>
        ...
        function listSchool(value, row, index){
            var str = '';
