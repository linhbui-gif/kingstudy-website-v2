                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <div class="col-md-3 control-label">
                                <label>Tên ngành học<span class="required"></span></label>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="icon_name" name="icon_name" value="{{@$object->icon_name}}">
                                <label id="icon_name-error" class="error" for="icon_name" style="display: none;"></label>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#form_update').validate({
                ...
                messages: {
                    name: "Vui lòng nhập tên ngành học",
                },
