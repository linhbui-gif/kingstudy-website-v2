                    ...
                    <div class="EditProfile-form-control flex flex-wrap"> 
                      ...
                      <div class="EditProfile-form-item flex items-center">
                        ...
                        <div class="Input small bordered">
                          ...
                          type="number" name="father_phone" placeholder="">
                        </div>
                      </div>
                      <div class="EditProfile-form-item flex items-center">
                        <div class="ProfilePage-label">Email:</div>
                        <div class="Input small bordered">
                          <input class="Input-control" value="{{@$infor['father_email']}}"
                          type="email" name="father_email" placeholder="">
                        </div>
                      </div>
                      <div class="EditProfile-form-item flex items-center">
                      ...
                      <div class="EditProfile-form-item flex items-center">
                        ...
                        <div class="Input small bordered">
                          ...
                          type="number" name="mother_phone" placeholder="">
                        </div>
                      </div>
                      <div class="EditProfile-form-item flex items-center">
                        <div class="ProfilePage-label">Email:</div>
                        <div class="Input small bordered">
                          ...
                          type="email" name="mother_email" placeholder="">
                        </div>
                      </div>
