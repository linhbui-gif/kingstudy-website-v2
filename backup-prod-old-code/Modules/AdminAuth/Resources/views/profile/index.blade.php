...
{{--                    </div>--}}
        ...
        <table id="demo-custom-toolbar" class="table table-bordered table-striped table-hover" cellspacing="0"
               ...
               data-striped="true"
               data-url="{!! route($controllerName.'.search') !!}?student_id={{ request()->get('id') }}"
               data-search="false"
        ...
        >
            ...
            <tr>
                ...
                <th data-field="school" data-sortable="true" data-formatter="formatSchool">Trường</th>
                <th data-field="created_at" data-sortable="true" data-formatter="formatDateDayTime">Ngày nộp</th>
