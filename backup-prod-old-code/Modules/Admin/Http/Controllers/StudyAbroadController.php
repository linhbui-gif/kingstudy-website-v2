...
use Modules\Admin\Repositories\StudyAbroad\StudyAbroadRepositoryInterface;
...
class StudyAbroadController extends Controller
{
    ...
    public function __construct(
        StudyAbroadRepositoryInterface $repository)
    {
        $this->repo = $repository;
        $this->data['controllerName'] = 'admin::studyAbroad';
        $this->view                   = 'admin::study-abroad';
    }
    ...
    public function search(Request $request)
    {
        ...
        $data = StudyAbroad::getListAll($filter);
    ...
    {
        $this->data['title'] = 'quốc gia du học';
        $params = $request->all();
        $params['type']         = $type;
    ...
    public function store(Request $request)
    {
        ...
        $data['slug'] = Str::slug($data['name_country'],'-');
        $obj = StudyAbroad::create($data);
        if ($obj) {
            if (!empty($temp_path))
            {
    ...
    public function edit($id)
    {
        ...
        $object = StudyAbroad::find($id);
       // $object['system_schools_items']      = json_decode($object['system_schools_items'],true);
        if (!$object) {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route($this->view.'.edit', ['id' => $id]);
    }
