      ...
      <div class="list-link">
          <div class="container">
              <ul class="nav">
                  ...
                  <li class="menu-item menu-item-type-taxonomy menu-item-object-university_category"><a class="active" class="" href="{{ route('tintucducho', [ 'slug' => $obj['slug'] ] )}}" data-electronic="news" target="_self" rel="follow noopener noreferrer">Tin tức du học</a></li>
              </ul>
          </div>
      </div>
