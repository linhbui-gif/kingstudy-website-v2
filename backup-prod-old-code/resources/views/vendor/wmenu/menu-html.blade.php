						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Chọn menu cần chỉnh sửa:</label>

									{!! Menu::select('menu', $menulist) !!}

									<span class="submit-btn">
										<input type="submit" class="button-secondary" value="Chỉnh sửa">
									</span>
									<span class="add-new-menu-action"> hoặc <a href="{{ $currentUrl }}?action=edit&menu=0">Thêm mới menu</a>. </span>
								</form>
							</div>
										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Link tùy chỉnh <span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-url-wrap">
																	<label class="howto" for="custom-menu-item-url"> <span>URL</span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-url" name="url" type="text" class="menu-item-textbox " placeholder=" Nhập url">
																	</label>
																</p>

																<p id="menu-item-name-wrap">
																	<label class="howto" for="custom-menu-item-name"> <span>Label</span>&nbsp;
																		<input id="custom-menu-item-name" name="label" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Nhập tên menu item">
																	</label>
																</p>
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenu()"  class="button-secondary submit-add-to-menu right"  >Thêm menu item</a>
												...
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														...
														<div class="publishing-action">
															<a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="button button-primary menu-save">Thêm mới menu</a>
														</div>
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Đặt từng mục theo thứ tự bạn thích. Bấm vào mũi tên bên phải của mục để hiển thị thêm các tùy chọn.
															</p>
														</div>
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Vui lòng nhập tên menu và chọn nút "Thêm mới menu"
															</p>
														</div>
														@endif
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<a class="item-cancel submitcancel hide-if-no-js button-secondary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Hủy bỏ</a>
																		<span class="meta-sep hide-if-no-js"> | </span>
