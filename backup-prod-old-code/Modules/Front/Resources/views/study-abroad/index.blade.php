      ...
      <div class="list-link">
          <div class="container">
              <ul class="nav">
                  ...
                  <li class="menu-item menu-item-type-taxonomy menu-item-object-university_category"><a class="" href="{{ route('truongdaihoc', [ 'slug' => $obj['slug']]) }}">Hệ thống trường</a></li>
  ...
  <section class="country-content">
      <div class="container">
          <div class="tab-contents active" id="school">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="main-content style-content style-content-2">
