...
?>
<nav aria-label="Page navigation" class="pagination-custom text-right">
    <div class="info">Hiển thị từ <strong>{!! $objects['from'] !!}</strong> đến <strong>{!! $objects['to'] !!}</strong> của <strong>{!! $objects['total'] !!}</strong> bảng ghi</div>
