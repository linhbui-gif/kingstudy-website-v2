    ...
    <div id="page-content">
        ...
        <ul class="nav nav-tabs">
            @foreach($positions as $position)
                <li class="tablinks {{$position['page']}}"><a href="{{route('admin::banner.type', ['type' => $position['page']])}}" >{{$position['description']}}</a></li>
            @endforeach
        </ul>
        <div class="panel panel-bordered-primary">
            @include("admin::includes.data-table",[
                ...
                'change_status'     => true,
                'fields' => [
                    ['field' => 'name','title' => 'Tên Banner'],
                    ['field' => 'image_location','title' => 'Hình ảnh','formatter' => 'formatImage'],
                    ['field' => 'banner_position.description','title' => 'Vị trí'],
                    ['field' => 'ordering','title' => 'Thứ tự'],
                    ['field' => 'url','title' => 'Liên kết','formatter' => 'formatUrl'],
