...
const ButtonComponent = ({
  className = '',
  hasIcon = false,
  styleButton = EStyleButton.Normal,
  bgUrlButton = '',
  onClick,
  link = '',
}) => {
    ...
    >
      <div
        className={`absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ${
          hasIcon ? 'flex w-full justify-center' : ''
        }`}
      >
        ...
        {styleButton === EStyleButton.CommingSoon && (
          <p
            className={
              'm-0 uppercase font-[400] text-[1rem] tracking-[5px] md:text-[2rem] md:tracking-[10px]'
            }
          >
            COMING SOON
          </p>
