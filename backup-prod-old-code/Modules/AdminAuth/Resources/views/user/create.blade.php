            ...
            <form id="frm-add" method="post" action="<?=$link?>" class="form-horizontal">
                <div class="panel-body">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="">Tỉnh/ Thành</label>
                            <div class="col-sm-9">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                {!! Form::select('role[]', $roles, @$role,['class' => 'form-control select2', 'multiple' => "multiple"]) !!}

                                <label id="role-error" class="error"
