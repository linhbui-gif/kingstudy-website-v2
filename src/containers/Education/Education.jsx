          ...
          {[1, 2, 3].map((element) => {
            return (
              <Col span={8} key={element}>
                ...
                >
                  <div className="box-svg mb-[3rem] transition ease-in-out group-hover:translate-y-[-10px]">
                    <svg
                      id="Group_3029"
                  ...
                  <div className="box-text">
                    <h4 className={'text-title-20 mb-[2rem]'}>
                      Mở rộng bản thân
                    </h4>
                    <p className={'text-body-14'}>
                      Expand your professional network, build your expertise,
                      and earn money on each paid enrollment and find the
                      university
                    </p>
                  </div>
                </div>
